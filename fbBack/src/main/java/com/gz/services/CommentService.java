...
//		return commentRepository.findAllQuery();
	...
	public Comment createComment(Comment comment) {
		...
		User userToSave=userRepository.findById(userId).orElseThrow(() -> new ResourceNotFoundException("User does not exist with id: " + userId));
