...
public class FbBackApplication {
	...
	protected void init() {
		...
		User kid = new User();
		kid.setUserName("kid");
		kid.setFirstName("Kid");
		kid.setLastName("Koala");
		kid.setPhoto("https://cdn.britannica.com/26/162626-050-3534626F/Koala.jpg");
		kid.setPassword(passwordEncoder.encode("kid"));
		kid.setEnabled(true);
		kid.setAuthorities(authorityList1);
		userDetailsRepository.save(kid);

		Post post1 = new Post("Keep your face always toward the sunshine - and shadows will fall behind you!", kid);
		postRepository.save(post1);

		Comment comment1 = new Comment("Very inspirational!", post1, user);
		commentRepository.save(comment1);
		Comment comment2 = new Comment("WW..", post1, kid);
		commentRepository.save(comment2);

		Post post2 = new Post("What a nice day!", user);
		postRepository.save(post2);
		Comment comment3 = new Comment("Nice indeed!", post2, kid);
